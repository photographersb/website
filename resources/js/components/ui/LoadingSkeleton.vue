<template>
  <div class="animate-pulse">
    <!-- Card Skeleton -->
    <div v-if="type === 'card'" class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
      <!-- Image Skeleton -->
      <div class="h-48 md:h-56 bg-gray-200"></div>
    ...
    <!-- List Item Skeleton -->
    <div v-else-if="type === 'list'" class="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
...
defineProps({
  type: {
    type: String,
    default: 'card', // card, list, profile, table-row, content
  },
});
</script>
