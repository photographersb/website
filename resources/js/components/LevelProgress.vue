<template>
  <div class="level-progress bg-gradient-to-br from-purple-600 to-blue-600 rounded-lg shadow-lg p-6 text-white">
    ...
    <div class="flex items-center justify-between mb-4">
      <div>
        <h3 class="text-sm font-medium text-purple-100">
          Your Level
        </h3>
    ...
    <div class="mb-4">
      ...
      <div class="w-full bg-purple-800 bg-opacity-30 rounded-full h-3">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-50 animate-shimmer" />
        </div>
      </div>
      <p class="text-xs text-purple-100 mt-2">
        {{ formatNumber(pointsToNextLevel) }} points to next level
      </p>
    </div>
    ...
    <div
      v-if="nextAchievement"
      class="mt-4 pt-4 border-t border-white border-opacity-20"
    >
      <p class="text-xs text-purple-100 mb-1">
        Next Achievement
      </p>
      <div class="flex items-center space-x-2">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-purple-200">
            {{ nextAchievement.progress }} / {{ nextAchievement.required_count }}
          </p>
        </div>
