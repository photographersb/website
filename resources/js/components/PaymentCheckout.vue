<template>
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-4xl">
      <h1 class="text-3xl font-bold mb-8">Payment Checkout</h1>
          ...
          <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div v-if="booking" class="space-y-4">
              <div class="flex items-center gap-4 pb-4 border-b">
                <img
                  :src="booking.photographer.avatar || 'https://via.placeholder.com/80'"
                  :alt="booking.photographer.user?.name || 'Photographer'"
                  class="w-16 h-16 rounded-full object-cover"
                />
                <div>
                  <h3 class="font-bold">{{ booking.photographer.user?.name || 'Unknown' }}</h3>
                  <p class="text-sm text-gray-600">{{ booking.photographer.bio }}</p>
                </div>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p class="font-semibold">{{ formatDate(booking.event_date) }}</p>
                </div>
                <div>
                  <p class="text-gray-600">Location</p>
                  <p class="font-semibold">{{ booking.event_location }}</p>
                </div>
                <div>
                  <p class="text-gray-600">Guest Count</p>
                  <p class="font-semibold">{{ booking.guest_count }} guests</p>
                </div>
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <div class="flex gap-2">
                  <img src="https://via.placeholder.com/40x25/1434CB/FFFFFF?text=VISA" alt="Visa" class="h-6" />
        ...
        <div class="md:col-span-1">
          <div class="bg-white rounded-lg shadow p-6 sticky top-4">
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-lg">
              <p class="text-sm font-semibold text-blue-900">Remaining Balance</p>
              <p class="text-2xl font-bold text-blue-700">৳{{ remainingAmount }}</p>
