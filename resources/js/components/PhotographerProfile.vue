    ...
    <div class="container mx-auto px-4 max-w-7xl -mt-20 relative z-10 pb-12">
      ...
      >
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white/90 rounded-2xl border border-[#eadfd7] shadow-lg p-6 transition-transform duration-300 hover:-translate-y-1">
            <div class="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <h2 class="text-2xl font-semibold font-serif text-gray-900 mb-2">
                  Why hire me
                </h2>
              ...
              <div class="flex flex-col gap-2 w-full sm:w-auto">
                <button
                  :disabled="isSelfBooking"
                  :class="[
                    'px-4 py-2 rounded-full font-semibold shadow-sm transition',
                    isSelfBooking
            ...
            <div class="flex flex-wrap gap-2 mt-4 text-sm">
              ...
              <span
                ...
                class="px-3 py-1 rounded-full bg-amber-100 text-amber-700"
              >
              ...
              <span
                v-if="photographer.portfolio_completeness"
                class="px-3 py-1 rounded-full bg-[#7a1f2b]/10 text-[#7a1f2b]"
              >
                {{ photographer.portfolio_completeness }}% complete
              </span>
            </div>

            <div class="flex flex-wrap gap-3 mt-4">
              <button
                class="px-4 py-2 rounded-full border border-[#eadfd7] text-gray-700 hover:border-[#7a1f2b] hover:text-[#7a1f2b] transition"
          ...
          <div class="bg-white/90 rounded-2xl border border-[#eadfd7] shadow-lg p-6 transition-transform duration-300 hover:-translate-y-1">
            ...
            <div
              v-if="locationLabel || serviceRadiusLabel"
              class="mt-4 flex flex-wrap gap-2"
            >
              <span
                v-if="locationLabel"
                class="inline-flex items-center gap-2 rounded-full border border-[#eadfd7] bg-white px-3 py-1.5 text-sm text-[#1b0b12]"
              >
                <svg
                  class="w-4 h-4 text-[#7a1f2b]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path d="M5.05 3.05a7 7 0 019.9 9.9L10 18l-4.95-5.05a7 7 0 010-9.9z" />
              ...
              <span
                v-if="serviceRadiusLabel"
                class="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1.5 text-sm text-amber-800"
              >
                <svg
                  class="w-4 h-4"
                  fill="currentColor"
            ...
            <div
              v-if="photographer.categories && photographer.categories.length > 0"
              class="mt-5 rounded-xl border border-[#eadfd7] bg-[#fbf7f3] p-4"
            >
              <h3 class="text-xs uppercase tracking-[0.3em] text-[#7a1f2b] mb-3">
                Categories
              </h3>
              <div class="flex flex-wrap gap-2">
                <span
                  ...
                  :key="category.id"
                  class="border border-[#eadfd7] bg-white text-[#7a1f2b] px-3 py-1.5 rounded-full text-sm font-semibold"
                >
                  {{ category.name }}
                </span>
              </div>
