  ...
  <div class="min-h-screen">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <section class="page-hero">
        <div class="hero-copy">
          <p class="hero-kicker">COMPETITION HUB</p>
          <h1 class="hero-title">Competitions, organized and alive.</h1>
          <p class="hero-subtitle">
            Monitor submissions, prize pools, and judging status in real time.
          </p>
        ...
        <div class="hero-status">
          ...
          <div class="status-card">
            ...
            <span class="status-value">{{ stats.active }}</span>
          </div>
          <div class="status-card">
            <span class="status-label">Pending Review</span>
            <span class="status-value">{{ formatNumber(stats.pendingSubmissions || 0) }}</span>
          </div>
        </div>
      </section>
      ...
      <div class="page-topbar">
        <div class="status-chip">
          Prize pool: ৳{{ formatNumber(stats.totalPrizePool || 0) }}
        </div>
      </div>
                ...
                <div class="competition-header">
                  ...
                  <div class="competition-actions">
                    ...
                    >
                      ...
                      <router-link
                        :to="`/admin/competitions/${comp.id}/submissions`"
                        class="btn-icon"
                    ...
                    <button
                      ...
                      title="Archive"
                      @click="archiveCompetition(comp.id)"
                    >
                      <svg
                        class="w-4 h-4"
                        fill="none"
                      ...
                      >
                        <path
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9-3h4m-4 0a1 1 0 11-2 0m2 0a1 1 0 10-2 0m-6 5h2m4 0h2"
                        />
                      </svg>
                    </button>
                    <button
...
export default {
  ...
  methods: {
    async fetchDashboardData() {
      try {
        ...
        const response = await api.get('/admin/competitions', {
          params: {
            stats_scope: 'dashboard'
          }
        });
        
        if (response.data.status === 'success') {
          const meta = response.data.meta || {};
          const stats = meta.stats || response.data.stats || {};
          const lists = meta.lists || response.data.lists || {};
    ...
    async archiveCompetition(id) {
      ...
      try {
        const response = await api.put(`/admin/competitions/${id}`, { is_archived: true });
