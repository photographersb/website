      ...
      <div class="max-w-4xl mx-auto">
        ...
        >
              ...
              <div class="flex-1">
                <div class="flex items-start justify-between">
                  <div>
                    ...
                    <p
                      v-if="mentor.country || mentor.city"
                      class="text-gray-500 mt-1"
                    >
          ...
          <div class="p-6 space-y-6">
            ...
            <!-- Social Media -->
            <div
              v-if="mentor.facebook_url || mentor.instagram_url || mentor.website_url"
              class="border-b pb-6"
            >
              <h3 class="text-lg font-semibold text-gray-900 mb-3">
                Social Media & Web
...
const fetchMentor = async () => {
  try {
    const { data } = await api.get(`/admin/mentors/${mentorId.value}`)
...
const toggleStatus = async () => {
  try {
    const { data } = await api.post(`/admin/mentors/${mentorId.value}/toggle-status`)
...
const deleteMentor = async () => {
  ...
  try {
    const { data } = await api.delete(`/admin/mentors/${mentorId.value}`)
    if (data.status === 'success') {
...
onMounted(() => {
  mentorId.value = resolveMentorId()
  fetchMentor()
})
</script>
