    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
          <p class="text-gray-600 mb-2">Assigned Competitions</p>
          <p class="text-3xl font-bold text-burgundy">{{ stats.total_competitions || 0 }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
          <p class="text-gray-600 mb-2">Total Submissions</p>
          <p class="text-3xl font-bold text-blue-600">{{ stats.total_submissions || 0 }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
          <p class="text-gray-600 mb-2">Scored</p>
          <p class="text-3xl font-bold text-green-600">{{ stats.scored || 0 }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
          <p class="text-gray-600 mb-2">Overall Progress</p>
          <p class="text-3xl font-bold text-burgundy">{{ overallProgress }}%</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow mb-8">
        <div class="px-6 py-4 border-b">
          <h2 class="text-xl font-bold text-gray-900">My Judging Assignments</h2>
        </div>
        ...
        <div v-else-if="competitions.length === 0" class="p-12 text-center text-gray-600">
          <svg class="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
          <p class="text-lg font-medium mb-2">No Judging Assignments</p>
          <p class="text-sm">You haven't been assigned to any competitions yet.</p>
        </div>
            ...
            <div class="flex items-start justify-between gap-4">
              ...
              <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-4 text-sm text-gray-600">
                  ...
                  <div v-if="competition.judging_deadline" class="flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          <button @click="$router.push('/competitions')" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-burgundy hover:bg-red-50 transition-all group">
            <svg class="w-8 h-8 text-gray-600 group-hover:text-burgundy mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button @click="$router.push('/notifications')" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-burgundy hover:bg-red-50 transition-all group">
            <svg class="w-8 h-8 text-gray-600 group-hover:text-burgundy mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button @click="$router.push('/help')" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-burgundy hover:bg-red-50 transition-all group">
            <svg class="w-8 h-8 text-gray-600 group-hover:text-burgundy mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button @click="$router.push('/settings')" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-burgundy hover:bg-red-50 transition-all group">
            <svg class="w-8 h-8 text-gray-600 group-hover:text-burgundy mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button @click="$router.push('/')" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-burgundy hover:bg-red-50 transition-all group">
            <svg class="w-8 h-8 text-gray-600 group-hover:text-burgundy mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
