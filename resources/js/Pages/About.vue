    ...
    <div class="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
          ...
          <p class="text-gray-700">
            To empower photographers across Bangladesh by providing them with a platform to showcase their work, connect with clients, and grow their business while delivering exceptional service to our users.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
          ...
          <p class="text-gray-700">
            To become the go-to platform for photography services in Bangladesh, recognized for quality, reliability, and innovation in connecting creative professionals with their ideal clients.
          </p>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="flex gap-4">
            <div class="flex-shrink-0">
              <div class="w-10 h-10 bg-burgundy-50 rounded-lg flex items-center justify-center">
                <span class="text-2xl">✓</span>
              </div>
            </div>
            <div>
              <h4 class="font-bold mb-2">Verified Photographers</h4>
              <p class="text-sm text-gray-600">All photographers are carefully verified to ensure quality and professionalism.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              <h4 class="font-bold mb-2">Transparent Reviews</h4>
              <p class="text-sm text-gray-600">Genuine client reviews help you make informed decisions.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">Safe and secure payment processing with multiple options.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              <h4 class="font-bold mb-2">Easy Communication</h4>
              <p class="text-sm text-gray-600">Direct messaging and inquiry system for seamless collaboration.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-burgundy text-white rounded-lg shadow-lg p-6 text-center">
          ...
          <div class="text-sm">Photographers</div>
        </div>
        <div class="bg-burgundy text-white rounded-lg shadow-lg p-6 text-center">
        ...
        <div class="bg-burgundy text-white rounded-lg shadow-lg p-6 text-center">
          ...
          <div class="text-sm">Cities Covered</div>
        </div>
        <div class="bg-burgundy text-white rounded-lg shadow-lg p-6 text-center">
      ...
      <div class="bg-white rounded-lg shadow-lg p-8">
        <h2 class="text-2xl font-bold mb-6 text-burgundy">Our Values</h2>
        <div class="space-y-4">
          <div>
            <h4 class="font-bold mb-2">🎯 Quality First</h4>
            <p class="text-gray-700">We maintain high standards for both photographers and client service.</p>
          </div>
          <div>
            <h4 class="font-bold mb-2">🤝 Trust & Transparency</h4>
            <p class="text-gray-700">Building trust through transparent processes and honest communication.</p>
          </div>
          <div>
            <h4 class="font-bold mb-2">🚀 Innovation</h4>
            <p class="text-gray-700">Constantly improving our platform with new features and technologies.</p>
          </div>
          <div>
            <h4 class="font-bold mb-2">💚 Community Focus</h4>
            <p class="text-gray-700">Supporting the photography community and fostering creative growth.</p>
          </div>
        </div>
      </div>
    </div>
