    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-burgundy via-[#8E0E3F] to-[#6F112D] text-white">
      ...
      <div class="container mx-auto px-4 py-12 md:py-16 relative z-10 text-center">
        ...
        <p class="text-base md:text-lg text-white/85 max-w-3xl mx-auto mt-4">
          How we use cookies and similar technologies on Photographer SB.
        </p>
      </div>
    </section>

    <div class="container mx-auto px-4 max-w-4xl -mt-10 relative z-10 pb-12">
      <div class="bg-white/90 rounded-xl shadow-lg p-6 mb-8 border border-gray-100">
        <p class="text-sm text-gray-600">
          <strong>Last Updated:</strong> February 5, 2026
        </p>
        <p class="text-gray-700 mt-3">
          This Cookie Policy explains how Photographer SB ("we", "us", or "our") uses cookies and similar tracking technologies when you visit our website at photographersb.com.
        </p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        ...
        <p class="text-gray-700 mb-4">
          Cookies are small text files that are stored on your device (computer, tablet, or mobile) when you visit a website. They help websites remember information about your visit, making it easier to use the site and providing information to the site owners.
        </p>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-50 rounded-lg p-6">
            ...
            <ul class="list-disc list-inside space-y-1 text-gray-600 ml-4">
              ...
              <li>Previously viewed photographers or searches</li>
          ...
          <div class="bg-gray-50 rounded-lg p-6">
            ...
            <ul class="list-disc list-inside space-y-1 text-gray-600 ml-4">
              <li>Visitor traffic and behavior patterns</li>
              <li>Popular pages and features</li>
              <li>Error tracking and performance monitoring</li>
              <li>A/B testing and optimization</li>
            </ul>
            <p class="text-sm text-gray-500 mt-3">
              We may use Google Analytics or similar tools for this purpose.
            </p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        ...
        <p class="text-gray-700 mb-4">
          Some cookies on our site are set by third-party services we use to enhance functionality and provide features:
        </p>
        <ul class="list-disc list-inside space-y-2 text-gray-700 ml-4">
          <li><strong>Google Analytics:</strong> Helps us analyze website traffic and usage patterns</li>
          <li><strong>Facebook Pixel:</strong> Enables targeted advertising on Facebook and Instagram</li>
          <li><strong>Payment Processors (bKash, Nagad):</strong> Facilitates secure payment transactions</li>
          <li><strong>Social Media Buttons:</strong> Allows sharing content on social platforms</li>
        </ul>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gray-50 rounded-lg p-6">
            <h3 class="font-bold mb-3 text-gray-900">
            ...
            <div class="space-y-2 text-sm">
              <div class="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span class="text-gray-600"> Settings → Privacy and security → Cookies and other site data</span>
                </div>
              </div>
              <div class="flex items-start gap-2">
                <span class="text-gray-600">•</span>
                <div>
                  ...
                  <span class="text-gray-600"> Options → Privacy & Security → Cookies and Site Data</span>
                </div>
              </div>
              <div class="flex items-start gap-2">
                <span class="text-gray-600">•</span>
                <div>
                  ...
                  <span class="text-gray-600"> Preferences → Privacy → Cookies and website data</span>
                </div>
              </div>
              <div class="flex items-start gap-2">
                <span class="text-gray-600">•</span>
                <div>
                  ...
                  <span class="text-gray-600"> Settings → Cookies and site permissions → Cookies</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p class="text-gray-700">
              You can also opt out of certain types of tracking using industry opt-out tools:
            </p>
            <ul class="list-disc list-inside space-y-1 text-gray-600 ml-4 mt-2">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        ...
        <p class="text-gray-700 mb-4">
          By continuing to use our website, you consent to our use of cookies as described in this policy. When you first visit our site, you'll see a cookie consent banner allowing you to:
        </p>
        <ul class="list-disc list-inside space-y-2 text-gray-700 ml-4">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-100">
        ...
        <p class="text-gray-700">
          We may update this Cookie Policy from time to time to reflect changes in technology, legislation, or our business practices. We will post the updated policy on this page with a revised "Last Updated" date. We encourage you to review this policy periodically.
        </p>
      </div>

      <!-- Contact -->
      <div class="bg-gradient-to-br from-burgundy to-[#8E0E3F] text-white rounded-xl shadow-lg p-8">
        ...
        <div class="mt-6">
          <router-link
            to="/contact"
            class="inline-block px-6 py-3 bg-white hover:bg-gray-100 text-burgundy font-medium rounded-lg transition-colors"
          >
            Contact Support
          </router-link>
        </div>
