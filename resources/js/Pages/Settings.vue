    ...
    <div class="bg-white border-b border-gray-200 mb-6">
      <div class="container mx-auto px-4 py-6 max-w-4xl">
        <div class="flex justify-between items-center">
          ...
          <router-link to="/" class="text-gray-600 hover:text-burgundy transition-colors">
            Back to Home
          </router-link>
        </div>
      </div>
      ...
      <!-- Settings Sections -->
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
              <label class="flex items-center gap-3">
                <input type="checkbox" checked class="w-4 h-4 text-burgundy border-gray-300 rounded focus:ring-burgundy">
            ...
            <button class="mt-4 px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors opacity-50 cursor-not-allowed" disabled>
              Coming Soon
            </button>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-red-500">
            ...
            <div class="space-y-3">
              <button class="px-4 py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-colors border border-red-200" disabled>
