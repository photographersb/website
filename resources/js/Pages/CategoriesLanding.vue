    ...
    <div class="max-w-7xl mx-auto">
      <div class="mb-12">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 class="text-5xl font-bold text-gray-900">Browse <span class="text-primary-700">Photography Categories</span></h1>
            <p class="text-lg text-primary-700 font-semibold mt-1">Find photographers by specialty and style</p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600">Select a category to view available photographers.</p>
          </div>
      ...
      <div v-if="loading" class="flex justify-center items-center py-20">
        <div class="text-center">
          ...
          <p class="text-primary-700 font-semibold">Loading categories...</p>
        </div>
      </div>

      <div v-else>
        <div v-if="filteredCategories.length === 0" class="bg-white rounded-2xl shadow-lg p-12 border border-gray-100 text-center">
