      ...
      <div class="bg-white rounded-lg shadow-lg p-8 space-y-6">
        ...
        <section>
          ...
          <ul class="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
            ...
            <li>Business information for photographers (portfolio, certifications)</li>
        ...
        <section>
          ...
          <ul class="list-disc list-inside text-gray-700 space-y-2 ml-4">
            ...
            <li><strong>Communication:</strong> Sending notifications, updates, and marketing (with consent)</li>
