        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600">
                    Find verified {{ $category->name }} photographers in {{ $location->name }}, Bangladesh
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach($photographers as $photographer)
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                        ...
                        <!-- Info -->
                        <div class="p-4">
                            <a href="{{ route('photographer.profile.public', ['username' => $photographer->user->username]) }}" class="block">
        ...
        @else
            <div class="text-center py-12">
                <p class="text-gray-600 text-lg">No photographers found in this category and location.</p>
            </div>
        @endif
    </div>
</div>
