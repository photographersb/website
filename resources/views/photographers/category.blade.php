        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">
                    {{ $category->name }} Photographers in Bangladesh
                </h1>
                <p class="text-lg text-gray-600">
                    Find verified {{ $category->name }} professionals nationwide
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @else
            <div class="text-center py-12">
                <p class="text-gray-600 text-lg">No photographers found in this category.</p>
            </div>
        @endif
    </div>
</div>
